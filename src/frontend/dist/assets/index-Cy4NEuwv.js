  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SiWhatsapp, { size: 28, className: "text-white relative z-10" })
      ]
    }
  );
}
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { "data-ocid": "footer", className: "bg-card border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10", children: [
          ...
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-primary text-base leading-tight", children: "Olympia Lily" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs font-medium", children: "Wellness Pvt. Ltd." })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: "Empowering Health, Enhancing Life. Premium nutritional supplements trusted across India." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-accent font-medium", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 14, className: "text-primary flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Nagaon, Assam, India 782002" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 14, className: "text-primary flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "tel:+919435561868",
                className: "hover:text-primary transition-smooth",
                children: "+91 94355 61868"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                className: "hover:text-primary transition-smooth",
                children: "+91 88767 65958"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SiWhatsapp, { size: 14, className: "text-primary flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "https://wa.me/919435561868",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-4 text-sm uppercase tracking-wider", children: "Delivery" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/5 border border-primary/20 rounded-2xl p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-primary text-sm", children: "Pan-India Delivery" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs leading-relaxed", children: "We deliver premium health supplements to every corner of India. Order today and experience wellness at your doorstep." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 14, className: "text-primary flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Available via WhatsApp & Call" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-xs text-center sm:text-left", children: [
        "© ",
        year,
        " Olympia Lily Wellness Private Limited. All rights reserved."
      ] }),
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      "data-ocid": "navbar",
      className: `fixed top-0 left-0 right-0 z-50 transition-smooth bg-card ${scrolled ? "shadow-elevated border-b border-border" : "border-b border-transparent"}`,
      children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-base leading-tight hidden sm:block text-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Olympia Lily" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm font-medium", children: "Wellness" })
                ] })
              ]
            }
          ),
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col p-4 gap-1", children: [
              navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: link.href,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-primary/10 text-primary border-primary/20 rounded-full px-4 py-1", children: "About Us" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground mb-4", children: "Our Story & Vision" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed", children: "Built on a foundation of trust, quality, and accessibility — Olympia Lily Wellness is transforming healthcare across India." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-14 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-md mx-auto lg:mx-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "absolute -inset-4 rounded-3xl opacity-20",
                style: {
                  background: "linear-gradient(135deg, oklch(0.52 0.16 145), oklch(0.65 0.18 253))"
                },
                "aria-hidden": true
              }
            ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-4 left-1/2 -translate-x-1/2 bg-card shadow-elevated border border-border rounded-2xl px-6 py-3 whitespace-nowrap text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-sm", children: "Abul Kalam Azad" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary text-xs font-medium", children: "Founder & Visionary" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed text-base mb-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Abul Kalam Azad" }),
                    " was born and raised in a",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "middle class family in Nagaon, Assam, India" }),
                    ". Growing up amidst the challenges of limited access to quality healthcare in the Northeast, he developed a deep passion for making wellness accessible to every family, regardless of their background."
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed text-base mb-4", children: [
                    "His humble beginnings gave him an unwavering commitment to affordability and trust — values that form the very foundation of",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Olympia Lily Wellness Private Limited" }),
                    ". Today, he leads the company with a singular vision: to bring premium-quality healthcare supplements within reach of every Indian household."
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed text-base", children: [
                    "Headquartered in",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Nagaon, Assam" }),
                    ", the company serves customers from the Northeast and across all of India, delivering scientifically formulated nutrition that makes a real difference in people's lives."
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-5 shadow-card", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-sm", children: "Our Mission" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "To empower every Indian with affordable, high-quality nutritional supplements that support long-term health and wellness." })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-5 shadow-card", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 16, style: { color: "oklch(0.65 0.18 253)" } })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-sm", children: "Our Vision" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "To become India's most trusted wellness brand — bridging the gap between modern science and accessible healthcare for all." })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-muted-foreground text-sm pt-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 16, className: "text-primary flex-shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                    "Based in",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Nagaon, Assam, India 782002" }),
                    " ",
...
Message: ${form.message}`
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-primary/10 text-primary border-primary/20 rounded-full px-4 py-1", children: "Contact Us" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed", children: "Ready to start your wellness journey? Contact us via WhatsApp, phone, or fill the form below — we'll get back to you promptly." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 fade-in", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-6 shadow-card", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-lg mb-5", children: "Contact Information" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "WhatsApp / Primary" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "a",
                      {
                        href: "https://wa.me/919435561868",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "Alternate Phone" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "a",
                      {
                        href: "tel:+918876765958",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "Address" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: "Nagaon, Assam, India — 782002" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mt-0.5", children: "🚚 Delivery across India only" })
                  ] })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  background: "linear-gradient(135deg, oklch(0.52 0.16 145 / 0.07), oklch(0.65 0.18 253 / 0.05))"
                },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🚚" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground", children: "Pan-India Delivery" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "We ship to every state in India" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
                    {
                      ...
                      onClick: () => window.open("https://wa.me/919435561868", "_blank"),
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(SiWhatsapp, { size: 16, className: "mr-2" }),
                        " Order on WhatsApp"
                      ]
                    }
                  )
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-6", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { size: 20, className: "text-primary" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-lg", children: "Send Us a Message" })
                ] }),
                submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-lg mb-2", children: "Message Sent!" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "We've opened WhatsApp with your message. We'll respond shortly!" })
                    ]
                  }
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center", children: "This will open WhatsApp with your message pre-filled." })
                ] })
              ]
            }
          )
...
const faqs = [
  {
    ...
    answer: "Yes! We deliver our premium wellness supplements to all 28 states and 8 union territories across India. Whether you're in a major metro city or a smaller town, we ensure your order reaches you reliably. Contact us via WhatsApp or call to place your order."
  },
  {
    question: "How can I place an order?",
    answer: "You can place an order by contacting us via WhatsApp at +91 94355 61868 or by calling us at +91 94355 61868 or +91 88767 65958. Our team will help you choose the right products and arrange delivery."
  },
  {
    question: "Are your products safe and quality-tested?",
    answer: "Absolutely. All Olympia Lily Wellness products are formulated using pharmaceutical-grade ingredients, verified for purity and potency. Our formulations are developed by nutrition experts and are free from harmful additives, artificial colors, or fillers."
  },
  {
    question: "What is the typical delivery time?",
    answer: "Delivery times vary by location. For most urban areas, expect delivery within 3-5 business days. For remote or rural areas, it may take 5-8 business days. We'll keep you updated on your order status."
  },
  {
    question: "Can I use multiple supplements together?",
    answer: "Most of our supplements are designed to be taken together as part of a complete wellness routine. However, we recommend consulting with your healthcare provider for personalized advice, especially if you have any existing medical conditions."
  },
  {
    question: "What payment methods do you accept?",
    answer: "We accept various payment methods including bank transfer, UPI, and cash on delivery for select locations. Contact us to discuss the payment option most convenient for you."
  },
  {
    question: "Are your products suitable for vegetarians?",
    answer: "Many of our products are vegetarian-friendly. Please contact us to inquire about specific products. We clearly communicate ingredients and dietary suitability for each supplement."
  },
  {
    question: "How do I know which supplement is right for me?",
    answer: "Our team is happy to help guide you based on your health goals. Contact us on WhatsApp with your requirements and our wellness advisors will recommend the best products for your needs."
  }
];
function FAQSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-primary/10 text-primary border-primary/20 rounded-full px-4 py-1", children: "FAQs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground mb-4", children: "Frequently Asked Questions" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg leading-relaxed", children: "Got questions? We've got answers. If you need more help, reach out via WhatsApp." })
        ] }),
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground text-sm leading-snug", children: faq.question }),
                    openIndex === i ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { size: 18, className: "text-primary flex-shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ChevronDown,
                      {
                        size: 18,
              ...
              openIndex === i && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-5 text-muted-foreground text-sm leading-relaxed border-t border-border pt-4 fade-in", children: faq.answer })
            ]
          },
          faq.question
        )) })
...
const trustBadges = [
  { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 18 }), label: "Trusted Formulations" },
  { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { size: 18 }), label: "Premium Quality" },
  { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Truck, { size: 18 }), label: "Pan-India Delivery" }
];
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none", "aria-hidden": true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.52 0.16 145), transparent 70%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.65 0.18 253), transparent 70%)"
              }
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                ...
                children: "🌿 Nagaon, Assam · Delivering Across India"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6", children: [
              ...
              "Enhancing",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.65 0.18 253)" }, children: "Life" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg leading-relaxed mb-8 max-w-lg", children: "Premium nutritional supplements formulated with the finest ingredients — Vitamins, Calcium, Protein, and Wellness products crafted for every Indian household." }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: trustBadges.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative fade-in", style: { animationDelay: "0.2s" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-3xl overflow-hidden shadow-elevated", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-4 left-4 right-4 bg-card/95 backdrop-blur-sm rounded-2xl p-4 shadow-elevated border border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-foreground", children: "Pan-India Delivery" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Order via WhatsApp or Call" })
              ] })
            ] }) })
          ] }) })
        ] }) })
...
const products = [
  {
    ...
    description: "A comprehensive blend of essential vitamins A, B, C, D, E & K to support immunity, energy, and overall vitality.",
    benefits: [
      "Boosts immunity",
  ...
  },
  {
    ...
    description: "Advanced calcium supplement enriched with Vitamin D3 and Magnesium for superior absorption and bone strength.",
    benefits: [
  ...
  },
  {
    ...
    description: "High-quality whey protein with essential amino acids for muscle recovery, growth, and sustained energy.",
    benefits: [
  ...
  },
  {
    ...
    description: "Certified KSM-66 Ashwagandha extract for stress relief, hormonal balance, and adaptogenic support.",
    benefits: [
  ...
  },
  {
    ...
    description: "Pharmaceutical-grade omega-3 fatty acids (EPA & DHA) for heart health, brain function, and joint mobility.",
    benefits: [
  ...
  },
  {
    ...
    description: "Targeted formula combining methylcobalamin B12 and iron to combat fatigue and support red blood cell formation.",
    benefits: [
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", role: "img", "aria-label": product.category, children: product.emoji }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-lg mb-2 leading-snug", children: product.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-4", children: product.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5 mb-5", children: product.benefits.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "li",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              variant: "outline",
              "data-ocid": `products.contact_button.${index2 + 1}`,
...
function ProductsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-primary/10 text-primary border-primary/20 rounded-full px-4 py-1", children: "Our Products" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground mb-4", children: "Premium Supplement Range" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed", children: "Scientifically formulated, quality-tested supplements across Vitamins, Calcium, Protein, and Wellness categories — trusted by thousands across India." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: products.map((product, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product, index: i }, product.name)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(135deg, oklch(0.52 0.16 145 / 0.08), oklch(0.65 0.18 253 / 0.06))"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-xl mb-2", children: "🚚 Pan-India Delivery Available" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-5", children: "Order any product via WhatsApp or phone. We deliver to every corner of India." }),
...
function TestimonialsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-primary/10 text-primary border-primary/20 rounded-full px-4 py-1", children: "Testimonials" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground mb-4", children: "What Our Customers Say" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto", children: "Thousands of customers across India trust Olympia Lily Wellness for their daily health needs." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: testimonials.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { size: 24, className: "text-primary/30 mb-3" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5 mb-3", children: Array.from({ length: t.rating }).map((_, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Star,
                {
                  size: 14,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed flex-1 mb-5", children: [
                '"',
                t.text,
                '"'
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pt-4 border-t border-border", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs", children: t.location })
                ] })
              ] })
            ]
          },
...
const reasons = [
  {
    ...
    description: "Every product is formulated by nutrition experts using clinically validated ingredients, ensuring efficacy and safety for your family.",
    color: "oklch(0.52 0.16 145)"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { size: 24 }),
    title: "High-Quality Ingredients",
    description: "We source only the finest raw materials — pharmaceutical-grade, non-GMO, and lab-tested for purity and potency.",
    color: "oklch(0.65 0.18 253)"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { size: 24 }),
    title: "Affordable Pricing",
    description: "Premium quality doesn't have to be expensive. We believe every Indian deserves access to high-quality nutrition at fair prices.",
    color: "oklch(0.60 0.12 160)"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Truck, { size: 24 }),
    title: "Pan-India Delivery",
    description: "Whether you're in a metro or a remote village, we deliver your supplements reliably across all 28 states and 8 union territories.",
    color: "oklch(0.52 0.16 145)"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { size: 24 }),
    title: "Natural & Safe",
    description: "Our products are free from harmful additives and artificial colors. Safe for daily use by adults, seniors, and children.",
    color: "oklch(0.60 0.12 160)"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(HeartHandshake, { size: 24 }),
    title: "Trusted by Customers",
    description: "Hundreds of satisfied customers across Northeast India and beyond trust Olympia Lily for their daily wellness needs.",
    color: "oklch(0.65 0.18 253)"
  }
];
function WhyChooseUsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-primary/10 text-primary border-primary/20 rounded-full px-4 py-1", children: "Why Choose Us" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-foreground mb-4", children: "The Olympia Lily Difference" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed", children: "We go beyond just selling supplements — we're committed to being your long-term health and wellness partner." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: reasons.map((reason, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-base mb-2", children: reason.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed", children: reason.description })
            ]
          },
          reason.title
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 bg-card border border-border rounded-3xl p-8 shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-6 text-center", children: [
